...
const Login = () => {
  const { user, handleUserSignIn,handleLogInUserWithGoogle,handleLogInUserWithGithub } = use(AuthContext);
...
<div className="flex justify-between pt-5">
  <button onClick={handleGithubPopup} className="btn bg-black text-white border-black">
...
{/* Google */}
<button onClick={handleGooglePopup} className="btn bg-white text-black border-[#e5e5e5]">
